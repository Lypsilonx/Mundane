...
By setting up your mood circle, you can control how mentally stable your character will be. A gradient from Sad to murderous (as listed [above](#moods)) would make them stable. Mixing the moods up will make them react wild and cause sudden changes in mood.

<hr>

### Importance

This determines what happens when your character [dies](#character-lifespan).
...
They can reward you for finishing [milestones](#milestones) or add their own (optional) milestones to the campaign.
...
<!-- omit in toc -->
#### What about magic?
Depending on your setting and character build, you may be able to use magic more easily. In general, you can always try to use magic, but it might be an [impossible check](#the-difficulty) for your average Stormtrooper.
